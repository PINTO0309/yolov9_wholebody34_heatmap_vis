...
def remove_output0_and_optimize_yolov9c(input_model_path, output_model_path):
    """
    Remove output0 from YOLOv9-C featext model and optimize by cleaning up unused nodes
    ...
    segmentation_descriptions = {
        "segmentation_model_4_Concat_output_0": "Primary feature (8x downsample, 512ch)",
        "segmentation_model_5_Concat_output_0": "Mid-resolution (16x downsample, 512ch)",
        "segmentation_model_2_Concat_output_0": "High-resolution (4x downsample, 256ch)",
        "segmentation_model_0_act_Mul_output_0": "Ultra high-res (2x downsample, 64ch)",
        "segmentation_model_7_Concat_output_0": "Deep global (32x downsample, 512ch)",
        "segmentation_model_4_cv4_conv_Conv_output_0": "CV4 module feature (512ch)",
        "segmentation_model_4_cv4_act_Mul_output_0": "CV4 activated feature (512ch)"
    }
...
if __name__ == "__main__":
    input_model = "yolov9_c_wholebody25_Nx3x640x640_featext.onnx"
    output_model = "yolov9_c_wholebody25_Nx3x640x640_featext_optimized.onnx"
    
    print("YOLOv9-C Feature Extraction Model Optimizer")
    print("=" * 60)
    ...
    removed = remove_output0_and_optimize_yolov9c(input_model, output_model)
    ...
    if removed:
        ...
        print("\nYOLOv9-C features:")
        print("  - Compact but powerful (~101MB)")
        print("  - Max 1024 channels (same as YOLOv9-E)")
        print("  - Rich CV3/CV4 modules for multi-scale features")
        print("  - Includes CV4 outputs for research purposes")
    else:
