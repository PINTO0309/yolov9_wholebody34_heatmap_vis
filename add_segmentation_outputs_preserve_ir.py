...
def add_segmentation_outputs_preserve_ir(input_model_path, output_model_path):
    """
    Add recommended segmentation layer outputs to YOLOv9e model
    ...
    # Recommended layers from the analysis report
    recommended_layers = [
...
if __name__ == "__main__":
    ...
    added = add_segmentation_outputs_preserve_ir(input_model, output_model)
