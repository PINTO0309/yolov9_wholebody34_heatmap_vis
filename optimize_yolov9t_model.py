...
def remove_output0_and_optimize_yolov9t(input_model_path, output_model_path):
    """
    Remove output0 from YOLOv9-T featext model and optimize by cleaning up unused nodes
    ...
    segmentation_descriptions = {
        "segmentation_model_2_Concat_output_0": "Primary feature (4x downsample, 64ch)",
        "segmentation_model_14_Concat_output_0": "Mid-resolution (8x downsample, 160ch)",
        "segmentation_model_11_Concat_output_0": "Deep semantic (16x downsample, 224ch)",
        "segmentation_model_0_conv_Conv_output_0": "Ultra high-res (2x downsample, 16ch)",
        "segmentation_model_8_Concat_output_0": "Global context (32x downsample, 256ch)"
    }
...
if __name__ == "__main__":
    input_model = "yolov9_t_wholebody25_Nx3x640x640_featext.onnx"
    output_model = "yolov9_t_wholebody25_Nx3x640x640_featext_optimized.onnx"
    
    print("YOLOv9-T Feature Extraction Model Optimizer")
    print("=" * 60)
    ...
    removed = remove_output0_and_optimize_yolov9t(input_model, output_model)
