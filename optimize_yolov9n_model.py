...
def remove_output0_and_optimize_yolov9n(input_model_path, output_model_path):
    """
    Remove output0 from YOLOv9n model and optimize by cleaning up unused nodes
...
if __name__ == "__main__":
    input_model = "yolov9_n_wholebody25_Nx3x640x640_featext.onnx"
    output_model = "yolov9_n_wholebody25_Nx3x640x640_featext_optimized.onnx"
    
    removed = remove_output0_and_optimize_yolov9n(input_model, output_model)
